...
@ToString
public class TCountryRegion implements Serializable {
  private static final long serialVersionUID = -6629843659842070506L;
  private int id;
  ...
  public boolean equals(Object o) {
    ...
    if (countryNumber != null
        ? !countryNumber.equals(that.countryNumber)
        : that.countryNumber != null) return false;
    ...
    if (regionCode != null ? !regionCode.equals(that.regionCode) : that.regionCode != null)
      return false;
    if (isCountry != null ? !isCountry.equals(that.isCountry) : that.isCountry != null)
      return false;
