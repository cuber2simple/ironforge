...
@ToString
public class TMccDef implements Serializable {
  private static final long serialVersionUID = -8421274948502569985L;
  private int id;
  ...
  public boolean equals(Object o) {
    ...
    if (officialNameEn != null
        ? !officialNameEn.equals(tMccDef.officialNameEn)
        : tMccDef.officialNameEn != null) return false;
    if (officialNameCn != null
        ? !officialNameCn.equals(tMccDef.officialNameCn)
        : tMccDef.officialNameCn != null) return false;
    ...
    if (updateUserId != null
        ? !updateUserId.equals(tMccDef.updateUserId)
        : tMccDef.updateUserId != null) return false;
    if (createUserId != null
        ? !createUserId.equals(tMccDef.createUserId)
        : tMccDef.createUserId != null) return false;
    if (expireDatetime != null
        ? !expireDatetime.equals(tMccDef.expireDatetime)
        : tMccDef.expireDatetime != null) return false;
    if (updateDatetime != null
        ? !updateDatetime.equals(tMccDef.updateDatetime)
        : tMccDef.updateDatetime != null) return false;
    if (createDatetime != null
        ? !createDatetime.equals(tMccDef.createDatetime)
        : tMccDef.createDatetime != null) return false;
