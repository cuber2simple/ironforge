...
@ToString
public class TCountry3166 implements Serializable {
  private static final long serialVersionUID = -1181646467046762502L;
  private int id;
  private String fifa;
  private String dial;
  ...
  public boolean equals(Object o) {
    ...
    if (alphaCode3 != null ? !alphaCode3.equals(that.alphaCode3) : that.alphaCode3 != null)
      return false;
    if (marc != null ? !marc.equals(that.marc) : that.marc != null) return false;
    if (isIndependent != null
        ? !isIndependent.equals(that.isIndependent)
        : that.isIndependent != null) return false;
    if (numberCode != null ? !numberCode.equals(that.numberCode) : that.numberCode != null)
      return false;
    ...
    if (alphaCode2 != null ? !alphaCode2.equals(that.alphaCode2) : that.alphaCode2 != null)
      return false;
    ...
    if (globalCode != null ? !globalCode.equals(that.globalCode) : that.globalCode != null)
      return false;
    if (intermediateRegionCode != null
        ? !intermediateRegionCode.equals(that.intermediateRegionCode)
        : that.intermediateRegionCode != null) return false;
    if (developType != null ? !developType.equals(that.developType) : that.developType != null)
      return false;
    if (universalCurrency != null
        ? !universalCurrency.equals(that.universalCurrency)
        : that.universalCurrency != null) return false;
    ...
    if (subRegionCode != null
        ? !subRegionCode.equals(that.subRegionCode)
        : that.subRegionCode != null) return false;
    ...
    if (intermediateRegionName != null
        ? !intermediateRegionName.equals(that.intermediateRegionName)
        : that.intermediateRegionName != null) return false;
    if (officialNameCn != null
        ? !officialNameCn.equals(that.officialNameCn)
        : that.officialNameCn != null) return false;
    if (officialNameEn != null
        ? !officialNameEn.equals(that.officialNameEn)
        : that.officialNameEn != null) return false;
    if (iso3166Name != null ? !iso3166Name.equals(that.iso3166Name) : that.iso3166Name != null)
      return false;
    if (localeName != null ? !localeName.equals(that.localeName) : that.localeName != null)
      return false;
    if (lastedDevelopedCountries != null
        ? !lastedDevelopedCountries.equals(that.lastedDevelopedCountries)
        : that.lastedDevelopedCountries != null) return false;
    if (regionName != null ? !regionName.equals(that.regionName) : that.regionName != null)
      return false;
    if (subRegionName != null
        ? !subRegionName.equals(that.subRegionName)
        : that.subRegionName != null) return false;
    if (globalName != null ? !globalName.equals(that.globalName) : that.globalName != null)
      return false;
    ...
    if (languages != null ? !languages.equals(that.languages) : that.languages != null)
      return false;
    if (geonameId != null ? !geonameId.equals(that.geonameId) : that.geonameId != null)
      return false;
    if (cldrDisplayName != null
        ? !cldrDisplayName.equals(that.cldrDisplayName)
        : that.cldrDisplayName != null) return false;
    ...
    if (expireDatetime != null
        ? !expireDatetime.equals(that.expireDatetime)
        : that.expireDatetime != null) return false;
    if (updateDatetime != null
        ? !updateDatetime.equals(that.updateDatetime)
        : that.updateDatetime != null) return false;
    if (createDatetime != null
        ? !createDatetime.equals(that.createDatetime)
        : that.createDatetime != null) return false;
  ...
  public int hashCode() {
    ...
    result =
        31 * result + (lastedDevelopedCountries != null ? lastedDevelopedCountries.hashCode() : 0);
